...
class Settings:
    ...
    COINMARKETCAL_API_KEY: str = os.environ.get("COINMARKETCAL_API_KEY", "").strip()
    ...
    # MACD Parameters (as per your request)
    ...
    # Bot Behavior
    # Poll every 5 minutes (300 seconds) for intra-candle checks
    POLL_SECONDS: int = int(os.environ.get("POLL_SECONDS", "300"))
